...
public class OBDDashboardsThirdPageFragment extends Fragment {
...
//                    //自定义
//                    for (int i = 9; i < 10; i++) {
//                        DBTool.getOutInstance().upDateValueByKey("dashboardsdisplaysizeandlocationwidth_" + i, DBTool.getOutInstance().getQueryKey("dashboardsdisplaysizeandlocationwidth_" + i).getValue() - 20);
...
//                    for (int i = 9; i < 10; i++) {
//                        DBTool.getOutInstance().upDateValueByKey("dashboardsdisplaysizeandlocationwidth_" + i + "_default", DBTool.getOutInstance().getQueryKey("dashboardsdisplaysizeandlocationwidth_" + i + "_default").getValue() - 20);
...
//新的Display   每次新建必须设置仪表盘id
        boards_one = new DashboardsView(getActivity(), 9);
