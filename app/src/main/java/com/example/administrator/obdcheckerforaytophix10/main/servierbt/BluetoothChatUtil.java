...
public class BluetoothChatUtil {
    ...
    //对外做的另一个准备 绑定Handler  其实可以放在 上面的单里里面 可是为了有些界面只是
    ...
    public synchronized void disconnect() {
        if (D)
            //LogUtil.fussenLog().d("disconnect");
            if (mConnectThread != null) {
                mConnectThread.cancel();
                mConnectThread = null;
            }
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            if (D)
                // LogUtil.fussenLog().d("BEGIN mAcceptThread");
            ...
            while (mState != STATE_CONNECTED) {
                try {
                    ...
                    LogUtil.fussenLog().d("accept() failed");
                    break;
                }
                // 如果连接被接受
                if (socket != null) {
                        ...
                        switch (mState) {
                            ...
                            case STATE_CONNECTED:
                                ...
                                try {
                                    ...
                                    //LogUtil.fussenLog().d("Could not close unwanted socket");
                                }
                                break;
                        }
                    }
            ...
            if (D){
                //LogUtil.fussenLog().d("END mAcceptThread");
            }
        }

        public void cancel() {
            if (D)
                // LogUtil.fussenLog().d("cancel " + this);
                try {
                    mServerSocket.close();
                } catch (IOException e) {
                    // LogUtil.fussenLog().d("close() of server failed");
                }
        }
    }
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            try {
                ...
                //LogUtil.fussenLog().d("create() failed");
                mmSocket = null;
            }
        }

        public void run() {
            //LogUtil.fussenLog().d("BEGIN mConnectThread");
            try {
        ...
        public void cancel() {
            try {
                ...
                //LogUtil.fussenLog().d("close() of connect socket failed");
            }
        }
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket) {
            // LogUtil.fussenLog().d("create ConnectedThread");
            mmSocket = socket;
            ...
            try {
                ...
                //LogUtil.fussenLog().d("没有创建临时sockets");
            }
            mmInStream = tmpIn;
            mmOutStream = tmpOut;
        }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    // LogUtil.fussenLog().d("disconnected");
                    connectionLost();
                    break;
                }
            }
        ...
        public void write(byte[] buffer) {
            try {
                ...
                //LogUtil.fussenLog().d("Exception during write");
            }
        }
